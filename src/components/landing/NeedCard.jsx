...
export default function NeedCard({ need }) {
  ...
  return (
    <article className="group flex h-full flex-col rounded-[20px] p-3 transition-all duration-500 hover:-translate-y-2 hover:bg-bone/70 hover:shadow-[0_22px_50px_rgba(67,57,46,0.10)]">
